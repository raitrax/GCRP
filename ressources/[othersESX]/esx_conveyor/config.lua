...
Config.Zones = {
	VehicleSpawner = {
			Pos   = {x = 3.905020,y = -668.013366,z = 31.238000 },
	...
	VehicleSpawnPoint = {
			Pos   = {x = -4.799306,y = -670.259826,z = 31.338100 },
			Size  = {x = 3.0, y = 3.0, z = 1.0},
        	Heading = 185.85,
			Type = -1
		},
	...
	CloakRoom = {
		Pos   = {x = 11.707007,y = -661.644958,z = 32.448760 },
		Size  = {x = 3.0, y = 3.0, z = 1.0},
		Color = {r = 0, g = 204, b = 3},
		Type = 1
	},
	RetourCamion = {
		Pos   = {x = -19.192045,y = -702.680480,z = 31.338100 },
