        ...
        if data.current.value == 'barman_outfit' then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
              ...
              if skin.sex == 0 then
                ...
                SetPedComponentVariation(playerPed, 8, 25, 0, 0) --T-shirt
                SetPedComponentVariation(playerPed, 11, 25, 7, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 0, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 25, 0, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 21, 0, 0) --Chaussures
...
AddEventHandler('esx_phone:loaded', function(phoneNumber, contacts)
  local specialContact = {
    name       = _U('bahama_phone'),
    number     = 'Bahama',
    base64Icon = 'https://i.imgur.com/s4bHmFQ.png'
  }
