...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'digilux' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenCloakroomMenu()
  ...
  local elements = {
        ...
        {label = _U('digilux_outfit'), value = 'digilux_outfit'},
      }
  ...
  ESX.UI.Menu.CloseAll()
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'digilux_outfit' then
...
function OpenChestMenu()
    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'chest',
      {
        title    = _U('chest'),
        align    = 'top-left',
        elements = elements,
      ...
      function(data, menu)
        ...
        if data.current.value == 'put_stock' then
           OpenPutChestStocksMenu()
        end

        if data.current.value == 'get_stock' then
           OpenGetChestStocksMenu()
        end
      ...
      function(data, menu)
        ...
        CurrentAction     = 'menu_chest'
        CurrentActionMsg  = _U('open_chest')
        CurrentActionData = {}
      end
    )
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'digilux', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'digilux_actions',
    {
      title    = _U('digilux'),
      align    = 'top-left',
      elements = elements
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  align = 'top-left',
                  elements = {
                      {label = _U('computer'),     value = 'computer'},
                      {label = _U('laptop'),         value = 'laptop'},
                  }
              },
              function(data2, menu2)

                TriggerServerEvent('esx_digiluxjob:crafting', data2.current.value,{ lib = "mp_am_hold_up", anim = "purchase_beerbox_shopkeeper" })
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_digilux', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_digiluxjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_digiluxjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_digiluxjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_digiluxjob:putStockItems', itemName, count)
            end
...
function OpenGetChestStocksMenu()

  ESX.TriggerServerCallback('esx_digiluxjob:getChestStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_digiluxjob:getChestStockItem', itemName, count)
            end
...
function OpenPutChestStocksMenu()
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_digiluxjob:putChestStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_digiluxjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_digiluxjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_digiluxjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'digilux_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_digiluxjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
RegisterNetEvent('esx_digiluxjob:animsAction')
AddEventHandler('esx_digiluxjob:animsAction', function(animObj)
...
AddEventHandler('esx_digiluxjob:hasEnteredMarker', function(zone)
    ...
    if zone == 'Case' or zone == 'Motherboard' or zone == 'SSD' or zone == 'Graphiccard' then
...
AddEventHandler('esx_digiluxjob:hasExitedMarker', function(zone)

    CurrentAction = nil
    ESX.UI.Menu.CloseAll()
    if (zone == 'Sell') and PlayerData.job ~= nil and PlayerData.job.name == 'digilux' then
      TriggerServerEvent('esx_digiluxjob:stopSell')
    end 
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_digiluxjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_digiluxjob:hasExitedMarker', LastZone)
            end
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_chest' then
            OpenChestMenu()
        end
        ...
        if CurrentAction == 'digilux_sell' then
            TriggerServerEvent('esx_digiluxjob:startSell', CurrentActionData.zone)
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'digilux', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableservice', 'digilux')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'digilux', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and PlayerData.job.grade_name == 'boss' and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'digilux_actions') then
...
AddEventHandler('esx_digiluxjob:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_digiluxjob:teleportMarkers', position)
        end
...
function CreateBlip()
    if PlayerData.job ~= nil and PlayerData.job.name == Config.nameJob then   
        ...
        BlipCase = AddBlipForCoord(Config.Zones.Case.Pos.x, Config.Zones.Case.Pos.y, Config.Zones.Case.Pos.z)
        SetBlipSprite(BlipCase, Config.Zones.Case.BlipSprite)
        SetBlipColour(BlipCase, Config.Zones.Case.BlipColor)
        SetBlipAsShortRange(BlipCase, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Case.BlipName)
        EndTextCommandSetBlipName(BlipCase)  

        BlipMotherboard = AddBlipForCoord(Config.Zones.Motherboard.Pos.x, Config.Zones.Motherboard.Pos.y, Config.Zones.Motherboard.Pos.z)
        SetBlipSprite(BlipMotherboard, Config.Zones.Motherboard.BlipSprite)
        SetBlipColour(BlipMotherboard, Config.Zones.Motherboard.BlipColor)
        SetBlipAsShortRange(BlipMotherboard, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Motherboard.BlipName)
        EndTextCommandSetBlipName(BlipMotherboard) 

        BlipSSD = AddBlipForCoord(Config.Zones.SSD.Pos.x, Config.Zones.SSD.Pos.y, Config.Zones.SSD.Pos.z)
        SetBlipSprite(BlipSSD, Config.Zones.SSD.BlipSprite)
        SetBlipColour(BlipSSD, Config.Zones.SSD.BlipColor)
        SetBlipAsShortRange(BlipSSD, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.SSD.BlipName)
        EndTextCommandSetBlipName(BlipSSD) 

        BlipGraphiccard = AddBlipForCoord(Config.Zones.Graphiccard.Pos.x, Config.Zones.Graphiccard.Pos.y, Config.Zones.Graphiccard.Pos.z)
        SetBlipSprite(BlipGraphiccard, Config.Zones.Graphiccard.BlipSprite)
        SetBlipColour(BlipGraphiccard, Config.Zones.Graphiccard.BlipColor)
        SetBlipAsShortRange(BlipGraphiccard, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Graphiccard.BlipName)
        EndTextCommandSetBlipName(BlipGraphiccard)

        BlipCraft = AddBlipForCoord(Config.Zones.Craft.Pos.x, Config.Zones.Craft.Pos.y, Config.Zones.Craft.Pos.z)
        SetBlipSprite(BlipCraft, Config.Zones.Craft.BlipSprite)
        SetBlipColour(BlipCraft, Config.Zones.Craft.BlipColor)
        SetBlipAsShortRange(BlipCraft, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Craft.BlipName)
...
RegisterNetEvent('NB:openMenuDigilux')
AddEventHandler('NB:openMenuDigilux', function()
    OpenSocietyActionsMenu()
end)
