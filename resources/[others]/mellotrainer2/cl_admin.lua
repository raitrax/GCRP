...
RegisterNUICallback( "adminkick", function( data, cb ) 
	if ( data.action == "input" ) then 
		...
		TriggerServerEvent( 'mellotrainer:adminKick', id, "Kicked: Vous avez été expulsé du serveur." )
	end 
end )
...
Citizen.CreateThread(function()
	while true do
		...
		if NetworkIsSessionStarted() then
			TriggerEvent( "mellotrainer:init" )
			return
		end
	end
end )