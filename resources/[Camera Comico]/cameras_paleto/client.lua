...
Citizen.CreateThread(function()
	...
	while true do
		...
		if (isNearPC() and PlayerData.job ~= nil and PlayerData.job.name == 'police') then
			ShowInfo("Appuyez sur ~g~F~w~ pour allumer l'ordinateur de Paleto Bay.")
...
function isNearPC()
	...
	local distance = GetDistanceBetweenCoords(-449.35, 6012.51, 31.71, coords.x, coords.y, coords.z, true)
