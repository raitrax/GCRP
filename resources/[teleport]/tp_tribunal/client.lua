local TeleportFromTo = {
	["Police HeliPad"] = {
		positionFrom = { ['x'] = 224.7857, ['y'] = -419.5251, ['z'] = -118.1996, nom = "Sortie - Tribunal"},
		positionTo =   { ['x'] = 269.1495, ['y'] = -432.9684, ['z'] = 45.3249, nom = "Entrée - Tribunal"},
	},

	["Police HeliPad2"] = {
		positionFrom = { ['x'] = 236.1433, ['y'] = -412.8933, ['z'] = -118.1995, nom = "Entrée - Salle de jugement"},
		positionTo =   { ['x'] = 238.7442, ['y'] = -334.5409, ['z'] = -118.7734, nom = "Sortie - Salle de jugement"},
	},
}
