local TeleportFromTo = {
	["Police HeliPad"] = {
		positionFrom = { ['x'] = 452.4290, ['y'] = -993.8731, ['z'] = 25.9989, nom = "Go up - Heli-Pad"},
		positionTo = { ['x'] = 469.1937, ['y'] = -986.9882, ['z'] = 43.6916, nom = "Go down - Garage"},
	},

	["Police HeliPad2"] = {
		positionFrom = { ['x'] = -1042.3129, ['y'] = -828.0255, ['z'] = 10.8846, nom = "Go up - Heli-Pad"},
		positionTo = { ['x'] = -1106.9100, ['y'] = -832.7482, ['z'] = 37.6753, nom = "Go down - Garage"},
	},
}
