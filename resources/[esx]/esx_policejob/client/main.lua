...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'sergeantchef' then
    table.insert(elements, {label = _U('police_wear'), value = 'sergeantchef_wear'})
  end
  ...
  if PlayerData.job.grade_name == 'lieutenant' then
    ...
    table.insert(elements, {label = _U('police_wear'), value = 'capitaine_wear'})
  end
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    local elements = {}
      ...
      table.insert(elements, { label = 'Voiture cadet', value = 'pol11'})

    if PlayerData.job.grade_name == 'officer' then
	  table.insert(elements, { label = 'Patrouille 1', value = 'pol2'})
	  table.insert(elements, { label = 'Patrouille 2', value = 'pol3'})
	  table.insert(elements, { label = 'Patrouille 3', value = 'pol4'})
	  table.insert(elements, { label = 'Patrouille 4', value = 'pol7'})
	  table.insert(elements, { label = 'Patrouille 5', value = 'pol9'})
	  table.insert(elements, { label = 'Patrouille 6', value = 'pol11'})
	  table.insert(elements, { label = 'Patrouille 7', value = 'pol12'})
	  table.insert(elements, { label = 'INTERVENTION', value = 'riot'})
    end
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'police_actions',
    {
      ...
      elements = {
		...
		{label = _U('Brottsregister'),      value = 'criminalrecords'},
    ...
    function(data, menu)
      ...
      if data.current.value == 'citizen_interaction' then
	   ...
	   if data.current.value == 'criminalrecords' then
