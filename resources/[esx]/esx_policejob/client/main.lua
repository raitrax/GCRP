...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    table.insert(elements, {label =('Police Municipal'), value = 'grandfroidgendarmerie_wear'})
    end
  
  	if PlayerData.job.grade_name =='officer' then 
    table.insert(elements, {label =('Police Municipal'), value = 'grandfroidgendarmerie_wear'})
	table.insert(elements, {label =('Tenue Gendarme'), value = 's_m_y_sheriff_02'})
		-- table.insert(elements, {label =('Tenue Grand Froid Gendarme 2'), value = 'grandfroidgendarmerie2_wear'})
    end
  
  	if PlayerData.job.grade_name =='sergeant' then  
    table.insert(elements, {label =('Police National'), value = 's_m_y_cop_01'})
    table.insert(elements, {label =('Tenue Gendarme'), value = 's_m_y_sheriff_02'})
		-- table.insert(elements, {label =('Tenue Grand Froid Gendarme 2'), value = 'grandfroidgendarmerie2_wear'})
		-- table.insert(elements, {label =('Tenue Gendarmerie Maitre Chien'), value = 'maitrechien_wear'})
    end

    if PlayerData.job.grade_name =='inspecteur' then  
    table.insert(elements, {label =('Police National'), value = 's_m_y_cop_01'})
		-- table.insert(elements, {label =('Tenue Grand Froid Gendarme'), value = 'grandfroidgendarmerie_wear'})
		-- table.insert(elements, {label =('Tenue Grand Froid Gendarme 2'), value = 'grandfroidgendarmerie2_wear'})
		-- table.insert(elements, {label =('Tenue Gendarmerie Maitre Chien'), value = 'maitrechien_wear'})
		-- table.insert(elements, {label =('Tenue Pilote Gendarmerie'), value = 'pilotedegend_wear'})
    end
  
    if PlayerData.job.grade_name =='swat' then  
    table.insert(elements, {label =('Tenue RAID'), value = 'raid_wear'})
		-- table.insert(elements, {label =('Tenue Grand Froid Gendarme'), value = 'grandfroidgendarmerie_wear'})
		-- table.insert(elements, {label =('Tenue Grand Froid Gendarme 2'), value = 'grandfroidgendarmerie2_wear'})
		-- table.insert(elements, {label =('Tenue Gendarmerie Maitre Chien'), value = 'maitrechien_wear'})
		-- table.insert(elements, {label =('Tenue Pilote Gendarmerie'), value = 'pilotedegend_wear'})
    ...
    table.insert(elements, {label =('Police National'), value = 's_m_y_cop_01'})
		table.insert(elements, {label =('Tenue RAID'), value = 'raid_wear'})
		table.insert(elements, {label =('Gendarme'), value = 's_m_y_cop_02'})
		-- table.insert(elements, {label =('Tenue Gendarmerie Maitre Chien'), value = 'maitrechien_wear'})
		-- table.insert(elements, {label =('Tenue Pilote Gendarmerie'), value = 'pilotedegend_wear'})
    end
    ...
    table.insert(elements, {label =('Police National'), value = 's_m_y_cop_01'})
  	...
  	if PlayerData.job.grade_name =='boss' then  
	    table.insert(elements, {label =('s_m_m_chemsec_01'), value = 's_m_m_chemsec_01'})
    	table.insert(elements, {label =('s_m_m_ciasec_01'), value = 's_m_m_ciasec_01'})
		table.insert(elements, {label =('s_m_y_cop_01'), value = 's_m_y_cop_01'})
		table.insert(elements, {label =('s_m_y_swat_01'), value = 's_m_y_swat_01'})
		table.insert(elements, {label =('s_m_y_swat_02'), value = 's_m_y_swat_02'})
		-- table.insert(elements, {label =('s_m_y_sheriff_01'), value = 's_m_y_sheriff_01'})
    table.insert(elements, {label =('Tenue RAID'), value = 'raid_wear'})
    table.insert(elements, {label =('Police National'), value = 's_m_y_cop_01'})
    end 
  
  	if (PlayerData.job.grade_name =='sergeant' or PlayerData.job.grade_name =='lieutenant' or PlayerData.job.grade_name =='officer' or PlayerData.job.grade_name =='swat' or PlayerData.job.grade_name =='sergeant' or PlayerData.job.grade_name =='inspecteur' or PlayerData.job.grade_name =='sergeantchief' or PlayerData.job.grade_name =='boss') then  
      -- table.insert(elements, {label =('Tenue Gendarmerie Mobile'), value = 'gendmobile_wear'}) 
    end
	
	if (PlayerData.job.grade_name =='officer' or PlayerData.job.grade_name =='sergeant' or PlayerData.job.grade_name =='inspecteur' or PlayerData.job.grade_name =='swat' or PlayerData.job.grade_name =='sergeantchief' or PlayerData.job.grade_name =='lieutenant' or PlayerData.job.grade_name =='boss') then  
    	-- table.insert(elements, {label =('Tenue Motos Gendarmerie'), value = 'gendarmeriemoto_wear'})
    end
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 's_m_m_chemsec_01' then
        ...
        if skin.sex == 0 then
          ...
          SetModelAsNoLongerNeeded(model)
            ...
            if data.current.value == 's_m_m_ciasec_01' then
      ...
      if data.current.value == 's_m_y_cop_01' then
        ...
        if skin.sex == 0 then
          ...
          SetModelAsNoLongerNeeded(model)
            ...
            if data.current.value == 's_m_y_swat_01' then
    ...
    if data.current.value == 's_m_y_swat_02' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
        TriggerServerEvent("player:serviceOn", "police")

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_swat_02")
         ...
         if data.current.value == 'maitrechien_wear' then
      ...
      if data.current.value == 'raid_wear' then
      ...
      if data.current.value == 'gendmobile_wear' then
	  ...
	  if data.current.value == 'grandfroidgendarmerie2_wear' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
        TriggerServerEvent("player:serviceOn", "police")

        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_snowcop_01")
       ...
       if data.current.value == 'colonel_wear' then
     ...
     if data.current.value == 'gendarmeriemoto_wear' then
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    table.insert(elements, { label = 'Peugeot Expert Police National', value = 'police3' })
    table.insert(elements, { label = 'Wv Police National', value = 'pol9'})
    --table.insert(elements, { label = 'Clio Municipal', value = 'police2'})

    if PlayerData.job.grade_name == 'officer' then
      
      table.insert(elements, { label = 'Kangoo Gendarmerie', value = 'pranger'})
    end

  if PlayerData.job.grade_name == 'sergeant' then
      table.insert(elements, { label = 'Ford Focus Gendarmerie', value = 'police'})
	  table.insert(elements, { label = 'Moto Gendarmerie', value = 'policeb'})
	  table.insert(elements, { label = 'Moto Police National', value = 'pol4'})
	  table.insert(elements, { label = 'Wv', value = 'pol9'})
    table.insert(elements, { label = 'Kangoo Gendarmerie', value = 'pranger'})
  end

  if PlayerData.job.grade_name == 'inspecteur' then
      table.insert(elements, { label = 'Ford Focus Gendarmerie', value = 'police'})
      table.insert(elements, { label = 'Camion Gendarmerie', value = 'policet'})
      table.insert(elements, { label = 'Moto Gendarmerie', value = 'policeb'})
      table.insert(elements, { label = 'Moto Police National', value = 'pol4'})
	  table.insert(elements, { label = 'Wv', value = 'pol9'})
    table.insert(elements, { label = 'Kangoo Gendarmerie', value = 'pranger'})
  ...
  if PlayerData.job.grade_name == 'swat' then
      ...
      table.insert(elements, { label = 'Kangoo Gendarmerie', value = 'pranger'})
	  table.insert(elements, { label = 'Camion Gendarmerie', value = 'policet'})
	  table.insert(elements, { label = 'Megane RS Gendarmerie', value = 'police2'})
	  table.insert(elements, { label = 'Moto Gendarmerie', value = 'policeb'})
	  table.insert(elements, { label = 'Moto Police National', value = 'pol4'})
	  table.insert(elements, { label = 'Wv', value = 'pol9'})
    end
  ...
  if PlayerData.job.grade_name == 'sergeantchief' then
    ...
    if PlayerData.job.grade_name == 'lieutenant' then
	  ...
	  table.insert(elements, { label = 'Camion Gendarmerie', value = 'policet'})
	  table.insert(elements, { label = 'Megane RS Gendarmerie', value = 'police2'})
      table.insert(elements, { label = 'PSIG Gendarmerie', value = 'fbi'})
	  table.insert(elements, { label = 'Wv', value = 'pol9'})
	  table.insert(elements, { label = 'Moto Police National', value = 'pol4'})
	  table.insert(elements, { label = 'Moto Gendarmerie', value = 'policeb'})
	  table.insert(elements, { label = '508 BAC', value = 'police4'})
    end

    if PlayerData.job.grade_name == 'boss' then
	  table.insert(elements, { label = 'fbi', value = 'fbi'})
      table.insert(elements, { label = 'police', value = 'police'})
      table.insert(elements, { label = 'police2', value = 'police2'})
      table.insert(elements, { label = 'police3', value = 'police3'})
	  table.insert(elements, { label = 'police4', value = 'police4'})
	  table.insert(elements, { label = 'police5', value = 'police5'})
    table.insert(elements, { label = 'police6', value = 'police6'})
    table.insert(elements, { label = 'police7', value = 'police7'})
    table.insert(elements, { label = 'policeb', value = 'policeb'})
    table.insert(elements, { label = 'policet', value = 'policet'})
...
function OpenPoliceActionsMenu()
	...
	'default', GetCurrentResourceName(), 'police_actions',
	{
        ...
        {label = 'Interpol',      value = 'criminalrecords'},
			}
		...
		if CurrentAction ~= nil then
			...
			if IsControlPressed(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'police' and (GetGameTimer() - GUI.Time) > 150 then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:BossMenuOpen1', 'police', function(data, menu)
						menu.close()
						CurrentAction     = 'menu_boss_actions'
						CurrentActionMsg  = _U('open_bossmenu')
						CurrentActionData = {}
