...
AddEventHandler('onClientMapStart', function()
	...
	ESX.TriggerServerCallback('esx_coffeemachine:requestDBItems', function(coffeemachineItems)
		for k,v in pairs(coffeemachineItems) do
...
function OpenShopMenu(zone)
	...
	for i=1, #Config.Zones[zone].Items, 1 do
		...
		table.insert(elements, {
			label     = item.label .. ' - <span style="color:white;">$' .. item.price .. ' </span>',
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			TriggerServerEvent('esx_coffeemachine:buyItem', data.current.value, data.current.price)
		end,
		function(data, menu)
