      ...
      --if zone == 'Sell' then
         if xPlayer.getInventoryItem('computer').count > 0 then
            SetTimeout(2000, function()
               local money = math.random(1000,1250)
                  xPlayer.removeInventoryItem('computer', 1)
                  xPlayer.addMoney(money)
                  TriggerClientEvent('esx:showNotification', xPlayer.source, _U('computer_money_earned') .. money)
                  Sell(source, zone)
               end)
         elseif xPlayer.getInventoryItem('laptop').count > 0 then
            SetTimeout(2000, function()
               local money = math.random(900,1050)
                  xPlayer.removeInventoryItem('laptop', 1)
                  xPlayer.addMoney(money)
                  TriggerClientEvent('esx:showNotification', xPlayer.source, _U('laptop_money_earned') .. money)
                  Sell(source, zone)
               end)
         else
...
RegisterServerEvent('esx_digiluxjob:stopSell')
AddEventHandler('esx_digiluxjob:stopSell', function()
