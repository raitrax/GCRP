...
function OpenCloakroomMenu()
    ...
    table.insert(elements, {label = 'Batman', value = 'freemode_ped', maleModel = 'BatmanTDK', femaleModel = 'BatmanTDK'})
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
	...
	table.insert(elements, { label = 'BatMobil', value = '1989'})
	table.insert(elements, { label = 'Vigilante', value = 'Vigilante'})	
    table.insert(elements, { label = 'Vide', value = 'Vide'})
	table.insert(elements, { label = 'Vide', value = 'Vide'})
	table.insert(elements, { label = 'Vide', value = 'Vide'})
