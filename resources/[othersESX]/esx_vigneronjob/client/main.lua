  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
      ...
      elements = {
        ...
        {label = _U('ems_clothes_ems'), value = 'vigne_wear'},
      },
    },
    function(data, menu)
...
AddEventHandler('esx_vigneronjob:hasEnteredMarker', function(zone)
		...
		if zone == 'TraitementJus' and PlayerData.job ~= nil and PlayerData.job.name == 'vigne'  then
		 ...
		 if zone == 'SellVin'and PlayerData.job ~= nil and PlayerData.job.name == 'vigne'  then
				 CurrentAction     = 'vine_resell'
                 CurrentActionMsg  = _U('press_sell')
                 CurrentActionData = {zone = zone}
         end
		 if zone == 'SellJus'and PlayerData.job ~= nil and PlayerData.job.name == 'vigne'  then
...
AddEventHandler('esx_vigneronjob:hasExitedMarker', function(zone)
  ESX.UI.Menu.CloseAll()
		...
		if (zone == 'TraitementVin' or zone == 'TraitementJus') then
			TriggerServerEvent('esx_vigneronjob:stopTransform')
		end
		--if (zone == 'SellFarm') then
		if (zone == 'SellVin' or zone == 'SellJus') then
...
function CreateBlip()
    if PlayerData.job ~= nil and PlayerData.job.name == Config.nameJob then   
        ...
        BlipRaisinFarm = AddBlipForCoord(Config.Zones.RaisinFarm.Pos.x, Config.Zones.RaisinFarm.Pos.y, Config.Zones.RaisinFarm.Pos.z)
        SetBlipSprite(BlipRaisinFarm, Config.Zones.RaisinFarm.BlipSprite)
        SetBlipColour(BlipRaisinFarm, Config.Zones.RaisinFarm.BlipColor)
        SetBlipAsShortRange(BlipRaisinFarm, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.RaisinFarm.BlipName)
        EndTextCommandSetBlipName(BlipRaisinFarm)  

        BlipTraitementVin = AddBlipForCoord(Config.Zones.TraitementVin.Pos.x, Config.Zones.TraitementVin.Pos.y, Config.Zones.TraitementVin.Pos.z)
        SetBlipSprite(BlipTraitementVin, Config.Zones.TraitementVin.BlipSprite)
        SetBlipColour(BlipTraitementVin, Config.Zones.TraitementVin.BlipColor)
        SetBlipAsShortRange(BlipTraitementVin, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.TraitementVin.BlipName)
        EndTextCommandSetBlipName(BlipTraitementVin) 
        ...
        BlipSellVin = AddBlipForCoord(Config.Zones.SellVin.Pos.x, Config.Zones.SellVin.Pos.y, Config.Zones.SellVin.Pos.z)
        SetBlipSprite(BlipSellVin, Config.Zones.SellVin.BlipSprite)
        SetBlipColour(BlipSellVin, Config.Zones.SellVin.BlipColor)
        SetBlipAsShortRange(BlipSellVin, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.SellVin.BlipName)
        EndTextCommandSetBlipName(BlipSellVin) 
        ...
        BlipVigneronActions = AddBlipForCoord(Config.Zones.VigneronActions.Pos.x, Config.Zones.VigneronActions.Pos.y, Config.Zones.VigneronActions.Pos.z)
        SetBlipSprite(BlipVigneronActions, Config.Zones.VigneronActions.BlipSprite)
        SetBlipColour(BlipVigneronActions, Config.Zones.VigneronActions.BlipColor)
        SetBlipAsShortRange(BlipVigneronActions, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.VigneronActions.BlipName)
        EndTextCommandSetBlipName(BlipVigneronActions) 
