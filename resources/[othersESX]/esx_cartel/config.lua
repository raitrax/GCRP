...
--      Pos     = { x = 425.130, y = -979.558, z = 30.711 },
	...
	{ name = 'WEAPON_GOLFCLUB',             price = 150 },
	{ name = 'WEAPON_CROWBAR',              price = 150 },
	{ name = 'WEAPON_BOTTLE',               price = 150 },
	{ name = 'WEAPON_DAGGER',       	      price = 150 },
	{ name = 'WEAPON_KNUCKLE',              price = 150 },
	{ name = 'WEAPON_BATTLEAXE',            price = 150 },
	...
	{ name = 'WEAPON_REVOLVER_MK2',         price = 900 },
	{ name = 'WEAPON_PISTOL_MK2',       	  price = 900 },	  
	{ name = 'WEAPON_FLAREGUN',      	      price = 50 },
	...
	{ name = 'WEAPON_MINISMG',              price = 1000 },
    { name = 'WEAPON_MICROSMG',             price = 1000 },
	...
	{ name = 'WEAPON_ASSAULTRIFLE_MK2',     price = 1000 },
	{ name = 'WEAPON_WEAPON_DBSHOTGUN',      	      price = 1000 },
	...
	{ name = 'WEAPON_SAWNOFFSHOTGUN',       price = 1000 },
      ...
      --{ name = 'WEAPON_BULLPUPSHOTGUN',       price = 50 },
	...
	{ name = 'WEAPON_STICKYBOMB',           price = 1500 }, 
	{ name = 'WEAPON_SMOKEGRENADE',      	  price = 900 },
	  --{ name = 'WEAPON_BZGAS',                price = 0 },
	{ name = 'WEAPON_MOLOTOV',              price = 300 },
