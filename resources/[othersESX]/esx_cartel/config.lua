...
--      Pos     = { x = 425.130, y = -979.558, z = 30.711 },
    ...
    AuthorizedWeapons = {
	  ...
	  { name = 'WEAPON_REVOLVER_MK2',         price = 150 },
	  { name = 'WEAPON_PISTOL_MK2',       	  price = 150 },	  
	  ...
	  { name = 'WEAPON_MINISMG',              price = 50 },
      { name = 'WEAPON_MICROSMG',             price = 50 },
	  { name = 'WEAPON_SMG',                  price = 50 },
	  ...
	  { name = 'WEAPON_STICKYBOMB',           price = 150 }, 
	  { name = 'WEAPON_SMOKEGRENADE',      	  price = 50 },
