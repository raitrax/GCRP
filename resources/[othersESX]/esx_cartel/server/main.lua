...
AddEventHandler('esx_carteljob:drag', function(target)
  ...
  TriggerClientEvent('esx_carteljob:drag', target, _source)
end)
...
ESX.RegisterServerCallback('esx_carteljob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_carteljob:buy', function(source, cb, amount)
