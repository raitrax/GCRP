...
RegisterServerEvent('tequilala:getStockItem')
AddEventHandler('tequilala:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('tequilala:getStockItems', function(source, cb)
...
RegisterServerEvent('tequilala:putStockItems')
AddEventHandler('tequilala:putStockItems', function(itemName, count)
...
RegisterServerEvent('tequilala:getFridgeStockItem')
AddEventHandler('tequilala:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('tequilala:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('tequilala:putFridgeStockItems')
AddEventHandler('tequilala:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('tequilala:buyItem')
AddEventHandler('tequilala:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('tequilala:craftingCoktails')
AddEventHandler('tequilala:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('tequilala:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('tequilala:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('tequilala:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('tequilala:getPlayerInventory', function(source, cb)
