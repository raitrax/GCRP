        ...
        ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  elements = {
                      ...
                      {label = 'mitraillette',             value = 'mitraillette'},
                  }
              },
...
function CreateBlip()
    if PlayerData.job ~= nil and PlayerData.job.name == Config.nameJob then   
        ...
        BlipFlacons = AddBlipForCoord(Config.Zones.Flacons.Pos.x, Config.Zones.Flacons.Pos.y, Config.Zones.Flacons.Pos.z)
        SetBlipSprite(BlipFlacons, Config.Zones.Flacons.BlipSprite)
        SetBlipColour(BlipFlacons, Config.Zones.Flacons.BlipColor)
        SetBlipAsShortRange(BlipFlacons, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Flacons.BlipName)
        EndTextCommandSetBlipName(BlipFlacons)  

        BlipNoAlcool = AddBlipForCoord(Config.Zones.NoAlcool.Pos.x, Config.Zones.NoAlcool.Pos.y, Config.Zones.NoAlcool.Pos.z)
        SetBlipSprite(BlipNoAlcool, Config.Zones.NoAlcool.BlipSprite)
        SetBlipColour(BlipNoAlcool, Config.Zones.NoAlcool.BlipColor)
        SetBlipAsShortRange(BlipNoAlcool, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.NoAlcool.BlipName)
        EndTextCommandSetBlipName(BlipNoAlcool) 

        BlipApero = AddBlipForCoord(Config.Zones.Apero.Pos.x, Config.Zones.Apero.Pos.y, Config.Zones.Apero.Pos.z)
        SetBlipSprite(BlipApero, Config.Zones.Apero.BlipSprite)
        SetBlipColour(BlipApero, Config.Zones.Apero.BlipColor)
        SetBlipAsShortRange(BlipApero, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Apero.BlipName)
        EndTextCommandSetBlipName(BlipApero) 

        BlipIce = AddBlipForCoord(Config.Zones.Ice.Pos.x, Config.Zones.Ice.Pos.y, Config.Zones.Ice.Pos.z)
        SetBlipSprite(BlipIce, Config.Zones.Ice.BlipSprite)
        SetBlipColour(BlipIce, Config.Zones.Ice.BlipColor)
        SetBlipAsShortRange(BlipIce, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(Config.Zones.Ice.BlipName)
        EndTextCommandSetBlipName(BlipIce) 
